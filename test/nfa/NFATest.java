...
public class NFATest {
	...
	public void test3_2() {
		...
		// This test is commented out because it is not testing the getState method, but rather the addTransition 
		// and getToState methods, which are tested in other test cases.
